    ...
    <ThemeProvider theme={lightTheme}>
      <Box>
        ...
        <Main>
          ...
          <Description>
            I am experienced in creating responsive and user-friendly web
        ...
        <Main>
          ...
          <Description>
            I specialize in building robust and scalable backend systems to
            support complex web applications.
          </Description>
          <Description>
            <strong>Skills</strong>
            <p>
              Node.js, Express, .NET, Laravel, Symfony, Flutter, spring boot,
              MongoDB, MySQL, Oracle, Docker{" "}
            </p>
          </Description>
        </Main>
